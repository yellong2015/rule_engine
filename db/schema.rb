...
ActiveRecord::Schema.define(version: 20170210122342) do
  ...
  create_table "rule_set_actions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "task_id"
    t.string "rule_set_id"
  end

  create_table "rule_sets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string  "name"
